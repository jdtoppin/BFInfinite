...
assertEqual(#BFI.changelog, 2, "preserved release count")
assertEqual(BFI.changelog[1].version, "r2-alpha", "latest preserved release")
assertEqual(BFI.changelog[2].version, "r1-alpha", "oldest preserved release")
assertEqual(#BFI.changelog[1].notes, 7, "all known r2 notes")
