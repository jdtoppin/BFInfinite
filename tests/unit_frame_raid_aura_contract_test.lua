...
local function assertCommonDescriptor(
    ...
    assertEqual(descriptor.visibility.requiresVisible, true,
...
local function assertRaidContract(preset)
    ...
    assertCommonDescriptor(buffDescriptor, preset.id, "buff", true)
    ...
    assertCommonDescriptor(debuffDescriptor, preset.id, "debuff", false)
...
assertEqual(totals.nativeVisibleCapacity, 640,
    "Raid native visible capacity")
assertEqual(totals.initialRestrictedButtons, 1600,
    "Raid initial restricted buttons")
assertEqual(totals.freshContainerCeiling, 1600,
