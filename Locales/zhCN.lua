...
L["BFI temporarily enables Blizzard's role-aware Progressive threat signal and restores it when released, without reading restricted threat values. For tanks, a warning color means threat is slipping and red means threat is lost; no warning means secure threat or no active threat."] = "BFI 会在需要时临时启用暴雪按职责判断的“渐进式”仇恨信号，并在释放后恢复原设置，全程不读取受限制的仇恨值。对坦克而言，警告颜色表示仇恨正在减弱，红色表示已失去仇恨；没有警告表示仇恨稳固或当前没有有效仇恨。"
L["Style"] = "样式"
L["Border"] = "边框"
L["Glow"] = "发光"
L["Border + Glow"] = "边框 + 发光"
