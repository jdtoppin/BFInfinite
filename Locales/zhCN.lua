...
L["Dispels"] = "驱散"
L["Damage Taken"] = "承受伤害"
L["Avoidable Damage Taken"] = "可避免的承受伤害"
L["Deaths"] = "死亡"
L["Enemy Damage Taken"] = "敌人承受伤害"
L["Damage + Healing + Damage Taken"] = "伤害 + 治疗 + 承受伤害"
...
L["Damage Meter Native Tip"] = "这些选项直接使用暴雪伤害统计的 CVar 和当前编辑模式布局。"
L["Damage Meter Layout Preset Tip"] = "无法覆盖暴雪预设。请选择或创建自定义编辑模式布局，以保存 BFI 布局更改。"
L["Damage Meter Windows Tip"] = "暴雪 12.1 最多支持三个独立统计窗口。窗口 1 始终存在；额外窗口和统计类别按角色保存。"
...
L["Damage Meter Skin Tip"] = "BFI 为暴雪战斗安全的伤害统计提供紧凑、类似聊天窗口的外观，不会替换其数据、排序、历史记录、技能明细或死亡回顾。"
