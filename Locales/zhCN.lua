...
L["Slot Spacing"] = "格子间距"
L["Damage Meter"] = "伤害统计"
L["Native Meter"] = "原生伤害统计"
L["Enable Damage Meter"] = "启用伤害统计"
L["Reset on New Instance"] = "进入新副本时重置"
L["Display"] = "显示"
L["Layout"] = "布局"
L["Meters"] = "统计窗口"
L["Blizzard Display (Read-only)"] = "暴雪显示（只读）"
L["Blizzard Layout (Read-only)"] = "暴雪布局（只读）"
L["Blizzard Meters (Read-only)"] = "暴雪统计窗口（只读）"
L["BFI Appearance"] = "BFI 外观"
...
L["Padding"] = "间距"
L["Text Size"] = "文字大小"
L["Window Opacity"] = "窗口不透明度"
L["Background Opacity"] = "背景不透明度"
L["Window Count"] = "窗口数量"
L["Place Meters Bottom Right"] = "将统计窗口置于右下角"
L["Damage Meter Actions"] = "伤害统计操作"
L["Reset Combat Data"] = "重置战斗数据"
L["Reset all native Damage Meter combat data?"] = "要重置所有原生伤害统计战斗数据吗？"
L["Damage Meter Native Tip"] = "BFI 可以安全地更改暴雪伤害统计的启用和重置 CVar。下方仅显示编辑模式数值，不会写入受保护的战斗条目。"
L["Damage Meter Native Settings Read Only"] = "原生数值为只读。请通过暴雪编辑模式修改；使用每个统计窗口标题栏中的下拉菜单选择伤害、治疗、承受伤害或其他类别。"
L["Damage Meter Layout Preset Tip"] = "无法覆盖暴雪预设。请选择或创建自定义编辑模式布局，以保存 BFI 布局更改。"
L["Damage Meter Windows Tip"] = "暴雪 12.1 最多支持三个独立统计窗口。请使用统计窗口标题栏中的原生菜单添加或关闭窗口并选择统计类别；BFI 会在此显示当前窗口数量。"
L["Damage Meter Loading"] = "正在加载暴雪伤害统计选项…"
L["Damage Meter Combat Deferred"] = "伤害统计布局更改将在战斗结束后应用。"
L["Damage Meter CVar Failed"] = "暴雪未接受伤害统计设置更改。"
L["Damage Meter Layout Applied"] = "已应用 BFI 伤害统计布局。"
L["Damage Meter Layout Requires Custom"] = "需要自定义编辑模式布局才能保存此更改。"
...
L["Damage Meter Window Menu"] = "暴雪伤害统计窗口菜单"
L["Open Blizzard Edit Mode"] = "打开暴雪编辑模式"
L["Damage Meter Skin Tip"] = "BFI 为暴雪战斗安全的伤害统计提供紧凑、类似聊天窗口的框架和现代化控件。战斗条目、数据、排序、历史记录、技能明细和死亡回顾完全由暴雪管理。"
L["Damage Meter Blizzard Controls Tip"] = "伤害统计的 CVar、编辑模式布局、战斗数据和按角色保存的窗口仍由暴雪统一管理。"
