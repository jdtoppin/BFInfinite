select(2, ...).L = setmetatable({
    ...
    ["Native special and quest widgets remain Blizzard-owned. Click targeting uses Blizzard's native region. Changes made during combat may be deferred until combat ends."] = "Native special and quest widgets remain Blizzard-owned. Click targeting uses Blizzard's native region. Changes made during combat may be deferred until combat ends.",
    ["portrait"] = "Portrait",
    ["powerBar"] = "Power Bar",
