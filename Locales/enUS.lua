select(2, ...).L = setmetatable({
    ...
    ["Damage Meter Skin Tip"] = "BFI skins Blizzard's combat-safe Damage Meter without replacing its data, row order, history, spell breakdowns, or death recap.",
    ["Damage Meter Blizzard Controls Tip"] = "Blizzard Edit Mode remains the source of truth for position, size, visibility, number format, bar height and spacing, class colors, and additional windows.",
    ["castBar"] = "Cast Bar",
