...
local function CreateNameplatesPanel()
    ...
    local compatibilityNotice = AF.CreateFontString(compatibilityPane, L["Native special and quest widgets remain Blizzard-owned. Changes made during combat may be deferred until combat ends."], "sand")
